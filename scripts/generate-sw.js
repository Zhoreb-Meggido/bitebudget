/**
 * Generate service worker with version from package.json
 */
...
const CACHE_NAME = 'bitebudget-v${version}';
const RUNTIME_CACHE = 'bitebudget-runtime-v${version}';
...
writeFileSync(join(rootDir, 'public', 'sw.js'), swTemplate, 'utf-8');
console.log(`✅ Generated sw.js with version ${version}`);
