...
export function PortionModal({ isOpen, onClose, portion, productName, onSave }: Props) {
  ...
  const { markDirty, markClean } = useModalLock('portion-modal');
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <input
              type="text"
              value={portionName}
              onChange={(e) => { setPortionName(e.target.value); markDirty(); }}
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div>
              ...
              <select
                value={unit}
                onChange={(e) => { setUnit(e.target.value as typeof unit); markDirty(); }}
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              >
          ...
          {unit === 'stuks' && (
            <div>
              ...
              <input
                ...
                inputMode="decimal"
                value={gramsPerUnit}
                onChange={(e) => { setGramsPerUnit(e.target.value); markDirty(); }}
                placeholder="Bijv. 35"
                className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                min="1"
              />
