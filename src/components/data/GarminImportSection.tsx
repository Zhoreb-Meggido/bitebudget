  ...
  return (
    <div className="bg-white rounded-lg shadow mb-6">
      <div className="p-4 sm:p-6 border-b border-gray-200">
        <h2 className="text-xl font-semibold text-gray-900">Fitness Data Import (Garmin CSV)</h2>
      ...
      <div className="p-4 sm:p-6 space-y-4">
        ...
        {files.length > 0 && parsedData.length === 0 && (
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="font-medium text-gray-900">Geselecteerde bestanden ({files.length})</h3>
              <button
                onClick={handleReset}
        ...
        {parsedData.length > 0 && (
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <h3 className="font-medium text-gray-900">Preview ({parsedData.length} dagen)</h3>
              <button
                onClick={handleReset}
                className="text-sm text-gray-600 hover:text-gray-900"
              >
                ...
                <table className="min-w-full divide-y divide-gray-200">
                  <thead className="bg-gray-50 sticky top-0">
                    <tr>
                      ...
                      <th className="px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase">Cal</th>
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {parsedData.slice(0, 50).map((day, index) => (
                      <tr key={index} className="hover:bg-gray-50">
                        <td className="px-3 py-2 text-sm text-gray-900 whitespace-nowrap">{day.date}</td>
                        <td className="px-3 py-2 text-sm text-gray-900">{day.calories?.total || '-'}</td>
